...
class DirectionalEnhance(nn.Module):
    ...
    def __init__(self, channel, kernel=3):
        ...
        # fusion layer
        self.fusion = SDFF(self.out_dim, 4, 4)
...
class SDFF(nn.Module):
    # modified from the basic version of MIRNet (https://github.com/swz30/MIRNet)
...
if __name__ == "__main__":
    ...
    _, C, _, _ = x.shape
    net = DirectionalEnhance(C, 3).cuda()
