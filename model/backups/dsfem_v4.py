...
class DSFEM(nn.Module):
    def __init__(self, channel):
        ...
        # directional conv
        self.DirectionalConv3 = DirectionalConvUnit(channel, 3, 1)
        self.DirectionalConv5 = DirectionalConvUnit(channel, 5, 2)
        self.DirectionalConv7 = DirectionalConvUnit(channel, 7, 3)
        self.DirectionalConv9 = DirectionalConvUnit(channel, 9, 4)

        # fusion layer
        # self.fusion = DepthWiseConv2d(channel, channel, 3, 1, 1)
        self.skff = SKFF(channel, 4, 4)
