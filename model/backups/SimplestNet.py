...
from model.module.dsfem_v2 import DirectionalEnhance
...
class SimplestNet(nn.Module):
    def __init__(
        ...
        # mcc
        self.mcc1 = SimpleFusion(embed_dim * 8)
        self.mcc2 = SimpleFusion(embed_dim * 4)
        self.mcc3 = SimpleFusion(embed_dim * 2)
        self.mcc4 = SimpleFusion(embed_dim)

        # Feature Enhancement
        self.fe_rgb0 = DirectionalEnhance(embed_dim, 3)
        self.fe_rgb1 = DirectionalEnhance(embed_dim * 2, 3)
        self.fe_rgb2 = DirectionalEnhance(embed_dim * 4, 3)
        self.fe_rgb3 = DirectionalEnhance(embed_dim * 8, 3)

        self.fe_nir0 = DirectionalEnhance(embed_dim, 3)
        self.fe_nir1 = DirectionalEnhance(embed_dim * 2, 3)
        self.fe_nir2 = DirectionalEnhance(embed_dim * 4, 3)
        self.fe_nir3 = DirectionalEnhance(embed_dim * 8, 3)
    ...
    def forward(self, x, nir):
        ...
        # feature enhancement
        rgb_layer0 = self.fe_rgb0(rgb_layer0) + rgb_layer0
        rgb_layer1 = self.fe_rgb1(rgb_layer1) + rgb_layer1
        rgb_layer2 = self.fe_rgb2(rgb_layer2) + rgb_layer2
        rgb_layer3 = self.fe_rgb3(rgb_layer3) + rgb_layer3

        nir_layer0 = self.fe_nir0(nir_layer0) + nir_layer0
        nir_layer1 = self.fe_nir1(nir_layer1) + nir_layer1
        nir_layer2 = self.fe_nir2(nir_layer2) + nir_layer2
        nir_layer3 = self.fe_nir3(nir_layer3) + nir_layer3
